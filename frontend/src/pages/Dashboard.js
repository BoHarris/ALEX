...
function Dashboard() {
  ...
  const { files, loading: fL, error: fE } = useRedactedFiles();
              ...
              {files.map((name) => (
                ...
                >
                  ...
                  <div className="flex gap-4">
                    <a
                      href={`${backendURL}/redacted/download/${name}`}
                      target="_blank"
                    ...
                    <a
                      href={`${backendURL}/redacted/report/${name}`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Download Report
                    ...
                    <a
                      href={`${backendURL}/redacted/report/${name}/pdf`}
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      Download PDF Report
